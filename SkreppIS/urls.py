...
urlpatterns = [
    ...
    url(r'^driver/(?P<name>[\w-]+)/toggleactive$', driver.views.DriverToggleActiveView.as_view(), name='drivertoggle'),
    url(r'^driver/(?P<name>[\w-]+)/changeactive$', driver.views.DriverChangeActiveView.as_view(), name='driverchangeactive'),
    ...
    url(r'^driver/(?P<name>[\w-]+)/addzone$', driver.views.ZoneCreateView.as_view(), name='dzonescreate'),
    url(r'^driver/(?P<driver>[\w-]+)/zonedelete$', driver.views.ZoneDestroyView.as_view(), name='dzonedelete'),
    url(r'^passenger/requestride$', driver.views.RideRequestCreateView.as_view(), name='riderequest'),
    url(r'^passenger/riderequests$', driver.views.RideRequestList.as_view(), name='riderequestlist'),
